                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <img src="{{asset('WHITELOGO.PNG-removebg-preview.png')}}" style="width:150px" alt="">

                                {{-- <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>RudraGraphics</h3> --}}
                            </a>
                            <h3>Sign In</h3>
                        </div>
                        ...
                        <button  type="submit" class="btn btn-primary py-3 w-100 mb-4" style="background-color: #f9603f">Sign In</button>
                        </form>
                    </div>
                </div>
            </div>
